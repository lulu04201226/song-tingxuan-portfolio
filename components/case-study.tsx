...
export function CaseStudy({project,charts}:{project:ProjectCaseStudy,charts:React.ReactNode}){
 ...
 return <main id="top"><section className="case-hero"><div className="case-intro"><span className="eyebrow">{project.eyebrow}</span><h1>{project.title}</h1><p className="lead">{project.question}</p><p className="case-summary">{project.summary}</p><GithubButton href={project.github}/></div><div className="decision-card"><span>决策结论</span><p>{project.decision}</p></div></section>
